...
VMODULE_ATOMIC_INLINE
int32_t vmodule_atomic_and(int32_t value, volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
 ...
 */
VMODULE_ATOMIC_INLINE
int32_t vmodule_atomic_acquire_load(volatile const int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
...
VMODULE_ATOMIC_INLINE
int32_t vmodule_atomic_release_load(volatile const int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
 ...
 */
VMODULE_ATOMIC_INLINE
void vmodule_atomic_acquire_store(int32_t value, volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
...
VMODULE_ATOMIC_INLINE
void vmodule_atomic_release_store(int32_t value, volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
 ...
 */
VMODULE_ATOMIC_INLINE
int vmodule_atomic_acquire_cas(int32_t oldvalue, int32_t newvalue,
...
VMODULE_ATOMIC_INLINE
int vmodule_atomic_release_cas(int32_t oldvalue, int32_t newvalue,
                               volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
    return (int)(!atomic_compare_exchange_strong_explicit(
...
VMODULE_ATOMIC_INLINE
void vmodule_memory_barrier(void)
{
    atomic_thread_fence(memory_order_seq_cst);
}
