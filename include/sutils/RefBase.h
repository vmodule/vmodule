...
public:
	...
	COMPARE_WEAK(==)COMPARE_WEAK(!=)COMPARE_WEAK(>)COMPARE_WEAK(<)COMPARE_WEAK(<=)COMPARE_WEAK(>=)
...
public:
	...
	void move_references(sp<TYPE>* d, sp<TYPE> const* s, size_t n) {
		...
		public:
			Renamer(sp<TYPE>* d, sp<TYPE> const* s) :
					d(d), s(s) {
			}
			virtual ~Renamer() {
			}
	...
	void move_references(wp<TYPE>* d, wp<TYPE> const* s, size_t n) {
		...
		public:
			Renamer(wp<TYPE>* d, wp<TYPE> const* s) :
					d(d), s(s) {
			}
			virtual ~Renamer() {
			}
